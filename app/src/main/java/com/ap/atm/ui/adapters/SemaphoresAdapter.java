...
import com.ap.atm.ui.activities.AddSemaphoreActivity;
import com.ap.atm.ui.activities.SemaphoresActivity;
...
public class SemaphoresAdapter extends RecyclerView.Adapter<SemaphoresAdapter.MyViewHolder> {
    private Context mContext;
    private List<SemaphoreModel> mListData;

    public SemaphoresAdapter(Context context, List<SemaphoreModel> listData) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            super(view);
            mView = view.findViewById(R.id.mMainViewItemSemaphore);
            mDate = view.findViewById(R.id.mDateItemSemaphore);
            mAddress = view.findViewById(R.id.mAddressGoogleSemaphore);
            mStreet1 = view.findViewById(R.id.mStreet1Semaphore);
            mStreet2 = view.findViewById(R.id.mStreet2Semaphore);
        }
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = null;
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_semaphore, parent, false);
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()){
                    case R.id.action_edit:
                        Intent intent = new Intent(mContext, AddSemaphoreActivity.class);
                        intent.putExtra(SessionUtils.params.semaphore.name(), mListData.get(position));
                        SemaphoresActivity mActivity = (SemaphoresActivity) mContext;
    ...
    private void deleteRegister(final int mPosition){
        ...
        String mUrl = ApiUtils.API_URL+ApiUtils.DELETE_SEMAFORO;
